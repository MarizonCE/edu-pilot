...
GET_MINERU_BATCH_ID_AND_UPLOAD_URL_TRY_INTERVAL_SECONDS = 2
...
MINERU_UPLOAD_FILE_TRY_INTERVAL_SECONDS = 2
...
# 从 MinerU 获取解析结果链接超时时间
MINERU_GET_EXTRACTED_RESULT_URL_TIMEOUT_SECONDS = 30
